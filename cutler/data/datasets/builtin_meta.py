...
def _get_builtin_metadata(dataset_name):
    ...
    elif dataset_name in ["imagenet", "kitti", "cross_domain", "lvis", "voc", "coco_cls_agnostic", "objects365", 'openimages', 'full_carotid', "carotid-mini", "mutinfo_val_carotid", "mutinfo_train_carotid"]:
